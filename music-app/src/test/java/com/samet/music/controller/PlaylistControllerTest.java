...
public class PlaylistControllerTest {
    ...
    public void testCreatePlaylistSuccess() {
        ...
        assertEquals("Çalma listesi ID'si doğru olmalı", Integer.valueOf(1), result.getId());
    ...
    public void testRemoveSongFromPlaylistSuccess() {
        ...
        songs.add(testSong);
        testPlaylist.setSongs(new HashSet<>(songs));
        ...
        updatedPlaylist.setSongs(new HashSet<>()); // Şarkı kaldırıldıktan sonra boş liste
