...
public class MusicCollectionViewTest {
    ...
    private SongController createSongController() {
        return new SongController(createUserController()) {
            ...
            public List<Song> getUserSongs() {
                ...
                // Song nesnelerini oluştur ve manuel olarak ID ata
            ...
            public List<Song> getSongsByArtist(String artist) {
                ...
                if (artist.equals("Test Artist 1")) {
                    Song song1 = new Song("Artist Song 1", artist, "Artist Album 1", "Rock", 2020, 180, "music/Test.mp3", 1);
                    song1.setId(1);
                    songs.add(song1);
                    
                    Song song2 = new Song("Artist Song 2", artist, "Artist Album 2", "Rock", 2021, 210, "music/Test2.mp3", 1);
                    song2.setId(2);
                    songs.add(song2);
                }
                return songs;
    ...
    public void testAddSongToAlbumFailure() {
        ...
        SongController mockController = new SongController(createUserController()) {
            ...
            public List<Song> getUserSongs() {
                List<Song> songs = new ArrayList<>();
                Song song = new Song("Test Song 1", "Test Artist 1", "Test Album 1", "Rock", 2020, 180, "music/Test.mp3", 1);
                song.setId(1);
                songs.add(song);
                return songs;
            }
