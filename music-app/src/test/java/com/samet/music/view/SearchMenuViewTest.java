...
public class SearchMenuViewTest {
    ...
    public void testAddSongsToPlaylist() {
        ...
        Playlist playlist = new Playlist("Test Playlist", "Description", playlistUser);
        playlist.setId(1);
    ...
    public void testNewSearch() {
        ...
        User songUser2 = new User();
        songUser2.setId(1);
        Song song2 = new Song("Another Song", "Another Artist", "Another Album", "Pop", 2022, 240, "path/to/another", songUser2);
        song2.setId(2);
