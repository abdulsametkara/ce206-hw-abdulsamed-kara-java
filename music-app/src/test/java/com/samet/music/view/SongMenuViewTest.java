...
public class SongMenuViewTest {
    ...
    public void testDisplayUserSongs() {
        ...
        Song song1 = new Song("Test Song 1", "Test Artist 1", "Test Album 1", "Rock", 2021, 180, "path/to/file1", 1);
        song1.setId(1);
        songs.add(song1);
        
        Song song2 = new Song("Test Song 2", "Test Artist 2", "Test Album 2", "Pop", 2022, 240, "path/to/file2", 1);
        song2.setId(2);
        songs.add(song2);
