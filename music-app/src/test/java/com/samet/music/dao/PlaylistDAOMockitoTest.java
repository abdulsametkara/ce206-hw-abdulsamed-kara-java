...
public class PlaylistDAOMockitoTest {
    ...
    public void testCreate() throws SQLException {
        ...
        assertEquals("Playlist ID doğru ayarlanmalı", Integer.valueOf(1), result.getId());
    ...
    public void testFindById() throws SQLException {
        ...
        assertEquals("Playlist ID eşleşmeli", Integer.valueOf(playlistId), result.get().getId());
