...
public class AlbumDAOTest {
    ...
    private class TestSongDAO extends SongDAO {
        ...
        public Song mapResultSetToSong(ResultSet rs) throws SQLException {
            ...
            mockUser.setId(1);
            return new Song("Test Song", "Test Artist", "Test Album", "Test Genre", 2023, 180, "/path/to/file", mockUser);
        }
    }
    ...
    public void testCreate() {
        ...
        assertEquals("Album ID 1 olmalı", Integer.valueOf(1), album.getId());
        ...
        assertEquals("Yıl eşleşmeli", Integer.valueOf(2023), album.getYear());
        assertEquals("Tür eşleşmeli", "Rock", album.getGenre());
        assertEquals("Kullanıcı ID eşleşmeli", Integer.valueOf(1), album.getUserId());
    }
    ...
    public void testAddSongsToAlbum() {
        ...
        User mockUser = new User();
        mockUser.setId(1);
        Song song1 = new Song("Song 1", "Test Artist", "Test Album", "Rock", 2023, 180, "/path/to/file1", mockUser);
        song1.setId(1);
        Song song2 = new Song("Song 2", "Test Artist", "Test Album", "Rock", 2023, 200, "/path/to/file2", mockUser);
        song2.setId(2);
        songs.add(song1);
        songs.add(song2);
    ...
    public void testUpdateAlbumGenreAndYear() {
        ...
        assertEquals("Yıl güncellenmiş olmalı", Integer.valueOf(2023), storedAlbum.getYear());
    ...
    public void testAddSingleSongToAlbum() {
        ...
        User mockUser = new User();
        mockUser.setId(1);
        Song song = new Song("Single Song", "Test Artist", "Test Album", "Rock", 2023, 180, "/path/to/file", mockUser);
        song.setId(1);
        songs.add(song);
