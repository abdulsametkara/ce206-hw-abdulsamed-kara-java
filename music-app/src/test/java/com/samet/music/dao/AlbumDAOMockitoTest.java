...
public class AlbumDAOMockitoTest {
    ...
    public void testCreateDirectImplementation() throws SQLException {
        ...
        assertEquals("Album ID should be set", Integer.valueOf(1), album.getId());
    ...
    public void testFindByIdDirectImplementation() throws SQLException {
        ...
        assertEquals("Album ID should match", Integer.valueOf(albumId), album.getId());
    ...
    public void testAddSongsToAlbumDirectImplementation() throws SQLException {
        ...
        User mockUser = new User();
        mockUser.setId(1);
        Song song1 = new Song("Song 1", "Artist", "Album", "Rock", 2023, 180, "/path", mockUser);
        song1.setId(1);
        Song song2 = new Song("Song 2", "Artist", "Album", "Pop", 2023, 200, "/path2", mockUser);
        song2.setId(2);
        songs.add(song1);
        songs.add(song2);
    ...
    public void testAddSongsToAlbumWithSQLException() throws SQLException {
        ...
        User mockUser = new User();
        mockUser.setId(1);
        Song song = new Song("Song 1", "Artist", "Album", "Rock", 2023, 180, "/path", mockUser);
        song.setId(1);
        songs.add(song);
