...
public class SongControllerTest {
    ...
    private class MockSongController extends SongController {
        ...
        public Song addSong(String title, String artist, String album, String genre, int year, int duration, String filePath) {
            ...
            Song song = new Song(title, artist, album, genre, year, duration, filePath, userController.getCurrentUser().getId());
    ...
    public void testAddSong() {
        ...
        assertEquals("Song should have correct year", 2023, addedSong.getYear());
        assertEquals("Song should have correct duration", 180, addedSong.getDuration());
    ...
    public void testAddAlbum() {
        ...
        assertEquals("Album should have correct year", 2023, addedAlbum.getYear());
