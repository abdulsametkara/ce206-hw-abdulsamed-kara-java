...
public class PlaylistMenuViewTest {
    ...
    private SongController createSongController() {
        return new SongController(userController) {
            ...
            public List<Song> getUserSongs() {
                ...
                Song song1 = new Song("Test Song 1", "Test Artist", "Test Album", "Rock", 2020, 180, "music/test.mp3", 1);
                song1.setId(1);
                
                Song song2 = new Song("Test Song 2", "Test Artist", "Test Album", "Pop", 2021, 240, "music/test2.mp3", 1);
                song2.setId(2);
        ...
        return new PlaylistController(userController) {
            ...
            public List<Playlist> getUserPlaylists() {
                if (playlists.isEmpty()) {
                    ...
                    Playlist playlist = new Playlist("Test Playlist", "Test Description", 1);
                    playlist.setId(1);
                    
                    // Playlist'e şarkı ekle
                    List<Song> songs = new ArrayList<>();
                    Song song = new Song("Playlist Song", "Test Artist", "Test Album", "Rock", 2020, 180, "music/test.mp3", 1);
                    song.setId(1);
                    songs.add(song);
    ...
    public void testRemoveSongsFromEmptyPlaylist() {
        ...
        PlaylistController emptyPlaylistController = new PlaylistController(userController) {
            ...
            public List<Playlist> getUserPlaylists() {
                List<Playlist> playlists = new ArrayList<>();
                Playlist playlist = new Playlist("Empty Playlist", "No songs", 1);
                playlist.setId(1);
                playlist.setSongs(new ArrayList<>()); // Empty songs list
                playlists.add(playlist);
                return playlists;
            }
